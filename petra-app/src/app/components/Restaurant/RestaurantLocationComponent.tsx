 ...
 * Location state
 */
export interface RestaurantLocationState {
	region: any;
	markers: any;
	mapStyle: any;
}
 ...
 * Location component
 */
export class RestaurantLocationComponent extends React.Component<RestaurantLocationProps, RestaurantLocationState> {
	/**
