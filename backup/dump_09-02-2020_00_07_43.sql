...
public	Museum	MuseumType	object	{"foreign_key_constraint_on": "museumTypeID"}	\N	f
\.
...
0769e927-478b-4c66-abf4-12492b2a258e	2020-02-08 21:06:40.124878+00
\.
...
b2b67716-0675-470b-a613-b2936736f682	28	2020-01-24 09:36:02.836131+00	{}	{"telemetryNotificationShown": true}
\.
...
COPY public."Museum" ("museumID", "companyID", "locationID", name, description, "museumTypeID") FROM stdin;
\.
...
4	OĞUZ	\N	oguz.eren@ceng.deu.edu.tr	\N	2020-01-24 17:48:59.328+00	2020-02-06 10:51:03.848+00	192.168.232.2	1	\N	1	f	\N	ya29.Il-7B4QOklpVuY-vVSM8G9FA7PGy5J5IaUixP3rcVGOzK7fO4GhDuZ6Rc4dTCi9Wb5h3Sdy3hKH4Y2r5hUioE6_Ibv1ZoGcP_bLqadC3WSA3isBeDF-Rrh-fly0yQEv51w
...
SELECT pg_catalog.setval('public."Location_locationID_seq"', 9, true);
...
SELECT pg_catalog.setval('public."RestaurantFoodType_restaurantFoodTypeID_seq"', 3, true);
...
SELECT pg_catalog.setval('public."User_userID_seq"', 76, true);
...
--
-- Name: Museum Museum_museumTypeID_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Museum"
    ADD CONSTRAINT "Museum_museumTypeID_fkey" FOREIGN KEY ("museumTypeID") REFERENCES public."MuseumType"("museumTypeID") ON UPDATE RESTRICT ON DELETE RESTRICT;
