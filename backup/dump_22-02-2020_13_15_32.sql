...
d63871f3-0c3c-49eb-913a-20d38f61d681	2020-02-22 07:52:10.486861+00
\.
...
SELECT pg_catalog.setval('public."ArchSiteTypeArchSite_archSiteTypeArchSiteID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."ArchSiteWorkingDaySchedule_archSiteWorkingDayScheduleID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."ArchSiteWorkingDay_archSiteWorkingDayID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."ArchSiteWorkingSchedule_archSiteWorkingScheduleID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."ArchSite_archSiteID_seq"', 2, true);
...
SELECT pg_catalog.setval('public."City_cityID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."Company_companyID_seq"', 8, true);
...
SELECT pg_catalog.setval('public."Location_locationID_seq"', 16, true);
...
SELECT pg_catalog.setval('public."RestaurantFood_restaurantFoodID_seq"', 2, true);
...
SELECT pg_catalog.setval('public."RestaurantType_restaurantTypeID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."TravelGuide_travelGuide_seq"', 2, true);
