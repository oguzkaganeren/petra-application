...
f35562e8-56da-4200-9223-ede350e9d537	2020-02-18 16:39:26.619453+00
\.
...
COPY public."Address" ("addressID", address, "districtID") FROM stdin;
1	test mah. no:35	1
\.
...
1	2020-02-07 21:00:00+00	2020-02-09 21:00:00+00	1
\.
...
COPY public."City" ("cityID", city, "countryID") FROM stdin;
1	İzmir	1
\.
...
2	asd	tax	test	1999-01-08 04:05:06+00	\N	\N	1	\N
3	asd	1453	test@test.com	2016-07-20 12:00:15+00	\N	\N	2	\N
4	Test Company	23-231-232	oguz@oguz.com	2020-02-02 16:05:53+00	\N	\N	3	\N
6	grapq	1453	cc@test.com	2016-07-20 12:00:15+00	\N	\N	5	\N
7	mobile comp	23-123-53	oguz@eren.com	2020-02-02 16:18:25+00	\N	\N	6	\N
\.
...
COPY public."District" ("districtID", district, "cityID") FROM stdin;
1	Buca	1
\.
...
2	6	8	my otel	\N	0	23123-2323
3	6	9	test2	\N	0	2332-23-21
\.
...
1	3	4	test comment	2020-02-08 11:25:14.088+00	2
\.
...
COPY public."Location" ("locationID", latitude, longtitude, "addressID") FROM stdin;
1	1.5	1.5	1
3	38.435444	27.141022	1
5	25.02	42.25	1
6	38.42727	27.145744	1
7	42.4	23.33	1
8	38.427883	27.141613	1
9	38.424496	27.138266	1
2	38.427883	27.141022	1
10	38.42434	27.139843	1
11	38.426197	27.152042	1
\.
...
COPY public."MuseumType" ("museumTypeID", type) FROM stdin;
\.
...
COPY public."MuseumTypeMuseum" ("museumTypeMuseumID", "museumID", "museumTypeID") FROM stdin;
\.
...
1	restR	1	yok	2020-02-17	0	11	6	123-12312
\.
...
COPY public."RestaurantMenu" ("restaurantMenuID", name, "restaurantID", price) FROM stdin;
1	menum	1	20
\.
...
COPY public."Room" ("roomID", "roomNo") FROM stdin;
1	2
2	42C
3	tes1
\.
...
1	23	2020-02-07 21:00:00+00	2020-02-14 21:00:00+00	3
\.
...
COPY public."RoomPropertyRoom" ("roomPropertyRoomID", "roomID", "roomPropertyID") FROM stdin;
1	1	1
2	1	2
3	2	1
4	2	2
...
1	4	testh	2020-02-17 09:13:39.447+00	232
2	4	testAll	2020-02-17 09:24:17.48+00	23
\.
...
75	MUHAMMET SEFA	\N	muhammet.durmus@ceng.deu.edu.tr	\N	2020-02-08 09:20:43.678+00	2020-02-08 09:20:43.678+00	192.168.1.100	1	\N	1	f	\N	ya29.Il-9Bxbe7RJj7-02n1f7y01xPBrEmANV9D1YZX9WQu9UubJDYzkmWa0i2D9-KQqoeLE4tOVUp4Tk5pGc5JvfUAgJOTG0jWwk6KgLSYxHPNTeq8nZYo-9JVq-EoJnhW1PuQ
76	KÜBRA	\N	kubra.ozturk@ceng.deu.edu.tr	\N	2020-02-08 09:47:17.645+00	2020-02-08 09:47:17.645+00	192.168.1.104	1	\N	1	f	\N	ya29.Il-9B51Cjv2eANoXzbWsWNGFRv0UURHy9a7YnEQ_5R2p1-43YsyJzGAbV1rfE2PBnaqKtWeVqT5BOYndBKObtTUPBBcBJPhIRtd3ZNR61cS-GAVLrjUikbUlAe5Ztk7fSw
4	OĞUZ	\N	oguz.eren@ceng.deu.edu.tr	\N	2020-01-24 17:48:59.328+00	2020-02-16 08:57:33.076+00	192.168.232.2	1	\N	1	f	\N	ya29.Il-7B4QOklpVuY-vVSM8G9FA7PGy5J5IaUixP3rcVGOzK7fO4GhDuZ6Rc4dTCi9Wb5h3Sdy3hKH4Y2r5hUioE6_Ibv1ZoGcP_bLqadC3WSA3isBeDF-Rrh-fly0yQEv51w
\.
...
SELECT pg_catalog.setval('public."ArchSiteType_archSiteTypeID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."ArchSite_archSiteID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."CompanyUser_companyUserID_seq"', 2, true);
...
SELECT pg_catalog.setval('public."Company_companyID_seq"', 7, true);
...
SELECT pg_catalog.setval('public."HotelService_hotelServiceHotelID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."Hotel_hotelID_seq"', 3, true);
...
SELECT pg_catalog.setval('public."MuseumTypeMuseum_museumTypeMuseumID_seq"', 1, false);
...
SELECT pg_catalog.setval('public."MuseumType_museumTypeID_seq"', 1, false);
...
SELECT pg_catalog.setval('public."RestaurantAndCuisineType_restaurantAndCuisineTypeID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."Restaurant_restaurantID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."User_userID_seq"', 77, true);
