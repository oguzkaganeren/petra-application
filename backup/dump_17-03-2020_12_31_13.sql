...
21ed7fc0-0b6d-4aec-b5b4-945303152edc	2020-03-17 07:51:54.504842+00
\.
...
d06be028-d799-4081-b3be-132c25fe2ea3	28	2020-02-15 17:11:47.675817+00	{}	{"telemetryNotificationShown": true}
\.
...
1	test mah. no:35	1	f	1
2	buca koop	1	f	1
3	test add asdas asdasdwas wasdwas	1	f	1
4	uckuyular	1	f	1
5	here we go agan'	1	f	1
6	test adress 123	1	f	1
10	asda sdas dasd 	1	f	1
\.
...
COPY public."ArchSite" ("archSiteID", "companyID", "locationID", name, description, age, period, altitude, diameter, destruction, "isDeleted") FROM stdin;
1	2	2	test	\N	\N	\N	\N	\N	\N	f
2	8	16	deneme arch	tst awdasda wdaw 	23	test 12312	20	30	asdaw 123	f
3	6	21	test2	adawfasd	23	12dsa	233	232	231asdas	f
\.
...
1	15	2020-03-14 21:00:00+00	2020-04-24 21:00:00+00	2	1	f
2	23	2020-03-16 21:00:00+00	2020-03-24 21:00:00+00	3	1	f
\.
...
1	13:00:00+00	21:00:00+00	1	f
2	04:07:00+00	09:42:00+00	1	f
\.
...
1	2020-02-07 21:00:00+00	2020-02-09 21:00:00+00	1	f
3	2020-03-01 21:00:00+00	2020-03-05 21:00:00+00	2	f
\.
...
COPY public."Article" ("articleID", title, content, "publishDate", "editDate", "isDeleted") FROM stdin;
\.
...
COPY public."City" ("cityID", city, "countryID", "isDeleted") FROM stdin;
1	İzmir	1	f
2	Aydın	1	f
\.
...
6	grapq	1453	cc@test.com	2016-07-20 12:00:15+00	\N	\N	5	\N	f
7	mobile comp	23-123-53	oguz@eren.com	2020-02-02 16:18:25+00	\N	\N	6	\N	f
8	test compan	1230-123-222	oguz@deneme.com	2020-02-22 11:30:33+00	\N	\N	15	\N	f
\.
...
2	6	8	my otel	\N	0	23123-2323	f
3	6	9	test2	\N	0	2332-23-21	f
4	6	12	new test hotel	\N	0	1230-123-2	f
\.
...
1	1.5	1.5	1	f
3	38.435444	27.141022	1	f
5	25.02	42.25	1	f
6	38.42727	27.145744	1	f
7	42.4	23.33	1	f
8	38.427883	27.141613	1	f
9	38.424496	27.138266	1	f
2	38.427883	27.141022	1	f
10	38.42434	27.139843	1	f
11	38.426197	27.152042	1	f
12	38.42989	27.141022	2	f
13	38.428665	27.143383	3	f
14	38.427578	27.142202	4	f
15	38.422794	27.140432	5	f
16	38.42295	27.134724	6	f
21	38.419666	27.138336	10	f
\.
...
COPY public."Museum" ("museumID", "companyID", "locationID", name, description, "isDeleted") FROM stdin;
1	6	13	test mus	here descr'oy	f
\.
...
1	22	2020-03-16 21:00:00+00	2020-03-30 21:00:00+00	1	1	f
\.
...
1	restR	1	yok	2020-02-17	0	11	6	123-12312	f
2	my rest22	1	yes	2020-02-22	0	14	6	123-123-2	f
\.
...
1	23	2020-02-07 21:00:00+00	2020-02-14 21:00:00+00	3	f
\.
...
1	4	testh	2020-02-17 09:13:39.447+00	232	f
2	4	testAll	2020-02-17 09:24:17.48+00	23	f
\.
...
COPY public."User" ("userID", name, surname, mail, "birthDate", "registerDate", "loginDate", "loginIP", "loginTypeID", "profileImageUrl", "userTypeID", "isBlocked", "phoneID", "accessToken", "isDeleted") FROM stdin;
75	MUHAMMET SEFA	\N	muhammet.durmus@ceng.deu.edu.tr	\N	2020-02-08 09:20:43.678+00	2020-02-08 09:20:43.678+00	192.168.1.100	1	\N	1	f	\N	ya29.Il-9Bxbe7RJj7-02n1f7y01xPBrEmANV9D1YZX9WQu9UubJDYzkmWa0i2D9-KQqoeLE4tOVUp4Tk5pGc5JvfUAgJOTG0jWwk6KgLSYxHPNTeq8nZYo-9JVq-EoJnhW1PuQ	f
76	KÜBRA	\N	kubra.ozturk@ceng.deu.edu.tr	\N	2020-02-08 09:47:17.645+00	2020-02-08 09:47:17.645+00	192.168.1.104	1	\N	1	f	\N	ya29.Il-9B51Cjv2eANoXzbWsWNGFRv0UURHy9a7YnEQ_5R2p1-43YsyJzGAbV1rfE2PBnaqKtWeVqT5BOYndBKObtTUPBBcBJPhIRtd3ZNR61cS-GAVLrjUikbUlAe5Ztk7fSw	f
4	OĞUZ	\N	oguz.eren@ceng.deu.edu.tr	\N	2020-01-24 17:48:59.328+00	2020-02-22 07:39:33.862+00	192.168.232.2	1	\N	1	f	\N	ya29.Il-7B4QOklpVuY-vVSM8G9FA7PGy5J5IaUixP3rcVGOzK7fO4GhDuZ6Rc4dTCi9Wb5h3Sdy3hKH4Y2r5hUioE6_Ibv1ZoGcP_bLqadC3WSA3isBeDF-Rrh-fly0yQEv51w	f
\.
...
SELECT pg_catalog.setval('public."ArchSiteEntranceType_archSiteEntranceTypeID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."ArchSitePrice_archSitePriceID_seq"', 2, true);
...
SELECT pg_catalog.setval('public."ArchSiteTypeArchSite_archSiteTypeArchSiteID_seq"', 2, true);
...
SELECT pg_catalog.setval('public."ArchSiteType_archSiteTypeID_seq"', 2, true);
...
SELECT pg_catalog.setval('public."ArchSite_archSiteID_seq"', 3, true);
...
SELECT pg_catalog.setval('public."CompanyPhone_companyPhoneID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."CompanyUser_companyUserID_seq"', 3, true);
...
SELECT pg_catalog.setval('public."Company_companyID_seq"', 11, true);
...
SELECT pg_catalog.setval('public."HotelRoom_hotelRoomID_seq"', 2, true);
...
SELECT pg_catalog.setval('public."HotelServiceProperty_hotelServicePropertyID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."HotelService_hotelServiceHotelID_seq"', 2, true);
...
SELECT pg_catalog.setval('public."Hotel_hotelID_seq"', 4, true);
...
SELECT pg_catalog.setval('public."Location_locationID_seq"', 21, true);
...
SELECT pg_catalog.setval('public."LoginType_loginTypeID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."MuseumPrice_museumPriceID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."MuseumTypeMuseum_museumTypeMuseumID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."MuseumType_museumTypeID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."Museum_museumID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."Phone_phoneID_seq"', 2, true);
...
SELECT pg_catalog.setval('public."RestaurantAndCuisineType_restaurantAndCuisineTypeID_seq"', 2, true);
...
SELECT pg_catalog.setval('public."RestaurantCuisineType_restaurantCuisineTypeID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."RestaurantFoodType_restaurantFoodTypeID_seq"', 4, true);
...
SELECT pg_catalog.setval('public."RestaurantFood_restaurantFoodID_seq"', 3, true);
...
SELECT pg_catalog.setval('public."RestaurantMenuFood_restaurantMenuFoodID_seq"', 2, true);
...
SELECT pg_catalog.setval('public."RestaurantMenu_restaurantMenuID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."RestaurantType_restaurantTypeID_seq"', 2, true);
...
SELECT pg_catalog.setval('public."Restaurant_restaurantID_seq"', 2, true);
...
SELECT pg_catalog.setval('public."RoomPrice_roomPriceID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."RoomPropertyRoom_roomPropertyRoomID_seq"', 6, true);
...
SELECT pg_catalog.setval('public."RoomProperty_roomPropertyID_seq"', 2, true);
...
SELECT pg_catalog.setval('public."Room_roomID_seq"', 3, true);
...
SELECT pg_catalog.setval('public."TravelGuideArchSite_travelGuideArchSiteID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."TravelGuideLocation_travelGuideLocationID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."TravelGuide_travelGuide_seq"', 3, true);
...
SELECT pg_catalog.setval('public."User_userID_seq"', 78, true);
