...
0cb26bf2-279d-4523-a9ae-e19f14edb050	2020-04-12 18:09:54.197303+00
\.
...
4	6	32	asdasd	asfasdasf	23	fasdfasda	23	23	afasdawdas	f
\.
...
3	35	2020-04-10 21:00:00+00	2020-04-17 21:00:00+00	2	1	f
\.
...
12	test	213124	oguz@kagan.com	2020-04-12 21:10:40+00	\N	\N	29	\N	f
\.
...
3	6	9	test2	bu kısımda otelin açıklaması gözükmektedir.	3	2332-23-21	f
7	6	24	star test	afawdasd	2	1231241	f
4	6	12	new test hotela	Açıklama	1	1230-123-2	f
6	6	23	description deneme	hello test	0	12312412	f
8	6	25	Test Hotel1	sdgswdasdw	5	241234123	f
\.
...
1	38.41998	27.14383	1	f
3	38.41998	27.14383	1	f
5	38.41998	27.14383	1	f
...
3	asdawd	1	afawdas	2020-04-12	0	30	6	1234123	f
\.
...
2	25	2020-04-04 21:00:00+00	2020-04-16 21:00:00+00	4	f
3	35	2020-04-05 21:00:00+00	2020-04-14 21:00:00+00	6	f
\.
...
1	4	testh	2020-02-17 09:13:39.447+00	232	t
\.
...
4	OĞUZ	\N	oguz@eren.com	\N	2020-01-24 17:48:59.328+00	2020-04-12 18:32:54.327+00	127.0.0.1	2	\N	5	f	\N	ya29.Il-7B4QOklpVuY-vVSM8G9FA7PGy5J5IaUixP3rcVGOzK7fO4GhDuZ6Rc4dTCi9Wb5h3Sdy3hKH4Y2r5hUioE6_Ibv1ZoGcP_bLqadC3WSA3isBeDF-Rrh-fly0yQEv51w	f	12345
...
SELECT pg_catalog.setval('public."ArchSitePrice_archSitePriceID_seq"', 3, true);
...
SELECT pg_catalog.setval('public."ArchSiteTypeArchSite_archSiteTypeArchSiteID_seq"', 4, true);
...
SELECT pg_catalog.setval('public."ArchSite_archSiteID_seq"', 4, true);
...
SELECT pg_catalog.setval('public."ArticleTag_articleTagID_seq"', 2, true);
...
SELECT pg_catalog.setval('public."ArticleUser_articleUserID_seq"', 2, true);
...
SELECT pg_catalog.setval('public."Article_articleID_seq"', 3, true);
...
SELECT pg_catalog.setval('public."CompanyPhone_companyPhoneID_seq"', 2, true);
...
SELECT pg_catalog.setval('public."CompanyUser_companyUserID_seq"', 4, true);
...
SELECT pg_catalog.setval('public."Company_companyID_seq"', 12, true);
...
SELECT pg_catalog.setval('public."HotelRoom_hotelRoomID_seq"', 6, true);
...
SELECT pg_catalog.setval('public."HotelServiceProperty_hotelServicePropertyID_seq"', 3, true);
...
SELECT pg_catalog.setval('public."HotelService_hotelServiceHotelID_seq"', 8, true);
...
SELECT pg_catalog.setval('public."Hotel_hotelID_seq"', 8, true);
...
SELECT pg_catalog.setval('public."Location_locationID_seq"', 32, true);
...
SELECT pg_catalog.setval('public."MuseumTypeMuseum_museumTypeMuseumID_seq"', 2, true);
...
SELECT pg_catalog.setval('public."Museum_museumID_seq"', 2, true);
...
SELECT pg_catalog.setval('public."Phone_phoneID_seq"', 3, true);
...
SELECT pg_catalog.setval('public."RestaurantAndCuisineType_restaurantAndCuisineTypeID_seq"', 3, true);
...
SELECT pg_catalog.setval('public."Restaurant_restaurantID_seq"', 3, true);
...
SELECT pg_catalog.setval('public."RoomPrice_roomPriceID_seq"', 3, true);
...
SELECT pg_catalog.setval('public."RoomPropertyRoom_roomPropertyRoomID_seq"', 15, true);
...
SELECT pg_catalog.setval('public."Room_roomID_seq"', 7, true);
...
SELECT pg_catalog.setval('public."Tag_tagID_seq"', 2, true);
...
SELECT pg_catalog.setval('public."TravelGuide_travelGuide_seq"', 7, true);
