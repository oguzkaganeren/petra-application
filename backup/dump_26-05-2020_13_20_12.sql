...
93f2988b-0ec0-4b24-bd6c-266f3a525cc1	2020-05-26 08:23:08.475452+00
\.
...
5	6	34	arch test	test description	22	23212	22	12	asdasfaw	f
6	8	38	deneme arch	no description	20	no period	0	450	no dest	f
\.
...
3	6	33	Test Museum	test description	f
4	12	35	deneme müze 1	asdasdsada	f
\.
...
4	OĞUZ	\N	oguz@eren.com	\N	2020-01-24 17:48:59.328+00	2020-05-26 09:39:59.328+00	127.0.0.1	2	\N	5	f	\N	ya29.Il-7B4QOklpVuY-vVSM8G9FA7PGy5J5IaUixP3rcVGOzK7fO4GhDuZ6Rc4dTCi9Wb5h3Sdy3hKH4Y2r5hUioE6_Ibv1ZoGcP_bLqadC3WSA3isBeDF-Rrh-fly0yQEv51w	f	12345
...
SELECT pg_catalog.setval('public."Address_addressID_seq"', 22, true);
...
SELECT pg_catalog.setval('public."ArchSitePrice_archSitePriceID_seq"', 5, true);
...
SELECT pg_catalog.setval('public."ArchSiteTypeArchSite_archSiteTypeArchSiteID_seq"', 6, true);
...
SELECT pg_catalog.setval('public."ArchSiteType_archSiteTypeID_seq"', 3, true);
...
SELECT pg_catalog.setval('public."ArchSite_archSiteID_seq"', 6, true);
...
SELECT pg_catalog.setval('public."Location_locationID_seq"', 38, true);
...
SELECT pg_catalog.setval('public."MuseumPrice_museumPriceID_seq"', 3, true);
...
SELECT pg_catalog.setval('public."MuseumTypeMuseum_museumTypeMuseumID_seq"', 4, true);
...
SELECT pg_catalog.setval('public."Museum_museumID_seq"', 4, true);
...
SELECT pg_catalog.setval('public."TravelGuideLocation_travelGuideLocationID_seq"', 3, true);
...
SELECT pg_catalog.setval('public."TravelGuideMuseum_travelGuideMuseumID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."TravelGuideRestaurant_travelGuideRestaurantID_seq"', 1, true);
...
SELECT pg_catalog.setval('public."TravelGuide_travelGuide_seq"', 8, true);
